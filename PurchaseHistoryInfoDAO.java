...
//				dto.setUserAddress(resultSet.getString("user_address"));
	...
	public int regist(String loginId, int productId, int productCount, int destinationId,
			int price, String productName, String productNameKana, String imageFilePath,
			String imageFileName, String releaseDate, String release_company) {
		DBConnector dbConnector = new DBConnector();
		Connection connection = dbConnector.getConnection();

		String sql = "insert into purchase_history_info(user_id, product_id, product_count, price, "
				+ "destination_id, regist_date, update_date, product_name, "
				+ "product_name_kana, image_file_path, "
		...
		try {
			...
			preparedStatement.setString(7, productNameKana);
			...
			preparedStatement.setString(11, release_company);
